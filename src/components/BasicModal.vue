<template>
  ...
  >
    <div
      class="relative min-w-[360px] w-full md:w-fit h-full md:h-fit min-h-[200px] bg-base-100 md:rounded-2xl top-0 left-0 md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 custom-animate max-md:overflow-auto"
    >

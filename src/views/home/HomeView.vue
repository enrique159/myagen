  ...
  <div class="home-container">
    ...
    <div class="p-6 space-y-6 relative h-full">
      <div class="dropdown dropdown-end w-full">
        <div tabindex="0" role="button" class="flex justify-between items-center gap-2 bg-base-100 pl-4 pr-2 py-2 rounded-2xl cursor-pointer active:scale-95 transition-transform duration-200">
          <div>
